"""
Shared helper — copy into the src/ of any service that needs to report errors.

Usage:
    from error_publisher import publish_error

    publish_error(
        source_service="appointment_service",
        error_code="APPT-500",
        error_message="Failed to create appointment record",
        payload={"patient_id": "P001", "doctor_id": "D003"}   # optional
    )

Routing key format: <source_service>.error
"""
